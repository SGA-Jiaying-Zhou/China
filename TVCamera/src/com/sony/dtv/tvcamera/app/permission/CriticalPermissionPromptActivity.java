...
public class CriticalPermissionPromptActivity extends Activity implements View.OnFocusChangeListener {

    private static final String TAG = "PermissionPrompt";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            mLaunchMode = getIntent().getIntExtra(PermissionConstants.LAUNCH_MODE_KEY, 0);
        }
    ...
    protected void onStart() {
        ...
        if (mManageAppPermissionsLaunched && mRequestPermissions != null) {
    ...
    private void initPermissionInfo() {
        ...
        mPermissionMessage.setText(String.format(
                getString(R.string.permission2a_prompt_message),
                name));
