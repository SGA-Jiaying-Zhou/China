...
public abstract class DialogActivity extends Activity
    ...
    private TextView mCustomHintText;
    private FrameLayout mCustomHintLayout;

    protected void showCustomHint(int visible, int strId) {
        if (strId != EMPTY) {
            mCustomHintText.setText(strId);
        }
        mCustomHintLayout.setVisibility(visible);
    }

    private void setCustomHintView() {
        mCustomHintText = (TextView) findViewById(R.id.custom_hint_txt);
        mCustomHintLayout = (FrameLayout) findViewById(R.id.custom_hint);
    }
